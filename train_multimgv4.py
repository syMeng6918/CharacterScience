...
parser.add_argument('--warmup_start_lr', type=float, default=0.0005)
parser.add_argument('--warmup_epochs', type=int, default=10)
parser.add_argument('--loss', type=str, default='asl', choices=['asl', 'focal', 'bce'])
parser.add_argument('--model', type=str, default='efficientnet', choices=['mobilenet', 'efficientnet', 'resnet18'])
